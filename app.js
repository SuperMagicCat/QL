...
const entries = [
  {"id":60,"category":"特殊效果词条","name":"流血","subtitle":"特殊效果词条 · 新增资料","meta":"待补充","tags":["特殊效果词条"],"description":"触发条件：当流血强度超过体质/5时\n效果：进行一次体质判定，如果判定失败则立即失去等同于流血强度的血量。判定成功则不受到伤害，流血强度减少｛1d（流血强度-体质/5）｝下次判定时成功要求加一级。\n持续与层数：流血不会自然减少，只有当血爆后才会消除","updated":60},
  ...
  {"id": 2, "category": "机制", "name": "加速的未来，折射的过去", "subtitle": "机制 · 文档资料", "meta": "文档资料", "tags": ["机制"], "description": "每当奥丁完成一次命运错位时，玩家获得一次加速未来或折射过去的机会。消耗机会可以使用（过去/当前）的判断结果来应对（当前/过去）同种类型的判断。如果选择折射过去，则回合会返回到过去对应的回合。", "updated": 55},
  ...
  {"id": 21, "category": "武器", "name": "伪·萝莉", "subtitle": "武器 · 文档资料", "meta": "文档资料", "tags": ["武器"], "description": "伤害3d10 使用拼刀规则时变为6d10 特殊效果： 1.该电：造成伤害后对目标施加1d20层带电，自己获得一半的带电 2.联通：自身每有一层带电，造成伤害额外+3 3.电极：自身不会因为带点而大失败 呼吸法（无） 侵蚀状态： 你对自身施加的带电层数变为超带电（目前至多10层）。 你不再因为自身的带电点数增加。", "updated": 36},
